...
#[universal_tool_router(
    cli(name = "mathtools", description = "Simple math operations")
)]
impl MathTools {
    /// Add two numbers
    #[universal_tool(
...
#[universal_tool_router(
    cli(name = "texttools", description = "Text analysis and manipulation")
)]
impl TextTools {
    ...
    async fn analyze_text(
        &self, 
        text: String,
        #[universal_tool_param(short = 'd', long = "detailed", description = "Show detailed analysis")]
        detailed: bool
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app = universal_tool_core::cli::clap::Command::new("example-cli")
        ...
        .subcommand(
            math_tools.create_cli_command()
                .name("math")
                .about("Math operations")
        )
        .subcommand(
            text_tools.create_cli_command()
                .name("text")
...
mod tests {
    ...
    async fn test_string_operations() {
        ...
        let result = tools.concat_strings(
            "Hello".to_string(),
            "World".to_string(),
            Some(", ".to_string())
        ).await.unwrap();
    ...
    async fn test_text_analysis() {
        ...
        // Test analyze
        let result = tools.analyze_text("Hello World".to_string(), false).await.unwrap();

...
TOOLS := anthropic_async claudecode_rs coding_agent_tools gpt5_reasoner pr_comments thoughts_tool universal_tool
# END:autotools TOOLS

# Tool alias mapping (autogenerated; do not edit inside markers)
# BEGIN:autotools ALIAS_CASE
ALIAS_CASE := case $$tool in anthropic_async) alias="anthropic" ;; claudecode_rs) alias="claude" ;; coding_agent_tools) alias="coding" ;; gpt5_reasoner) alias="gpt5" ;; pr_comments) alias="pr" ;; thoughts_tool) alias="thoughts" ;; universal_tool) alias="universal" ;; *) alias="" ;; esac

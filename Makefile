...
.PHONY: coding-check coding-test coding-build coding-all
.PHONY: fmt-all fmt-check-all clean-all status

# Default target
.DEFAULT_GOAL := help

# Tools to build (autogenerated; do not edit inside markers)
...
# Tool alias mapping (autogenerated; do not edit inside markers)
# BEGIN:autotools ALIAS_CASE
ALIAS_CASE := case $$tool in anthropic_async) alias="anthropic" ;; claudecode_rs) alias="claude" ;; coding_agent_tools) alias="coding" ;; gpt5_reasoner) alias="gpt5" ;; linear_tools) alias="linear" ;; pr_comments) alias="pr" ;; thoughts_tool) alias="thoughts" ;; universal_tool) alias="universal" ;; *) alias="" ;; esac
...
# Individual tool targets (autogenerated; do not edit inside markers)
# BEGIN:autotools TARGETS
...
# Individual tool targets - coding_agent_tools
coding-check:
	@$(MAKE) -C coding_agent_tools check

coding-test:
	@$(MAKE) -C coding_agent_tools test

coding-build:
	@$(MAKE) -C coding_agent_tools build

coding-all:
	@$(MAKE) -C coding_agent_tools all
...
# Individual tool targets - linear_tools
linear-check:
	@$(MAKE) -C linear_tools check

linear-test:
	@$(MAKE) -C linear_tools test

linear-build:
	@$(MAKE) -C linear_tools build

linear-all:
	@$(MAKE) -C linear_tools all

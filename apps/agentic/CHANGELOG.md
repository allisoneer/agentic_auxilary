...
### ⛰️  Features
- *(attention)* Establish protocol foundation
## [0.1.19] - 2026-07-21
## [0.1.18] - 2026-07-13

### ⛰️  Features
- *(agentic)* Standardize linear ticket corpus artifact prompts
## [0.1.17] - 2026-07-13

### 🐛 Bug Fixes
- *(agentic)* Neutralize installed opencode assets
## [0.1.16] - 2026-07-10

### 🐛 Bug Fixes
- Rename opencode agents and clarify claude auth env scope
## [0.1.15] - 2026-07-09

### ⛰️  Features
- *(agentic-bin)* Add repo-local opencode install command

### 🐛 Bug Fixes
- *(agentic)* Detect dangling symlinks during install
## [0.1.14] - 2026-07-08

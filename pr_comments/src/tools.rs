...
/// Convert universal_tool_core::ToolError to agentic_tools_core::ToolError.
fn convert_tool_error(e: universal_tool_core::prelude::ToolError) -> ToolError {
    // Map error codes appropriately
    let msg = e.to_string();
    if msg.contains("permission") || msg.contains("401") || msg.contains("403") {

...
TOOLS := "agentic-tools-core agentic-tools-macros agentic-tools-mcp anthropic_async claudecode_rs coding_agent_tools gpt5_reasoner linear_tools opencode_rs pr_comments thoughts_tool universal_tool"

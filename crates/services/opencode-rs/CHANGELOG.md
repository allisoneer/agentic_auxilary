...
### ⛰️  Features
- *(opencode-rs)* Add SSE readiness handshake
## [0.13.4] - 2026-08-12

### 🐛 Bug Fixes
- *(opencode-rs)* Expose command post attempt observation
## [0.13.3] - 2026-07-08
## [0.13.2] - 2026-07-05

### 🐛 Bug Fixes
- *(opencode-orchestrator-mcp)* Generate valid command message ids
## [0.13.1] - 2026-07-05

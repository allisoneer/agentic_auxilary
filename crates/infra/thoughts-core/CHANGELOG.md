...
### 🐛 Bug Fixes
- *(coding_agent_tools)* Remove just wrapper coupling
...
### 🐛 Bug Fixes
- *(thoughts)* Move mount diagnostics to mount layer

### 🧪 Testing
- *(thoughts)* Cover disconnected mount raw errors
## [0.12.0] - 2026-05-20
...
### ⚙️  Miscellaneous
- Updated the following local packages: agentic-tools-core, agentic_logging
## [0.11.5] - 2026-05-03
...
### 📚 Documentation
- Link docs from README; fix thoughts-core README staleness
- Update thoughts-core README for FUSE-T/macFUSE accuracy and strip emoji
## [0.11.3] - 2026-04-15

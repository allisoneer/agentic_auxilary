...
### ⛰️  Features
- *(cli_tools)* Add configurable just_execute page lines

### 🐛 Bug Fixes
- *(just)* Remove output mode from execute pagination
## [0.5.5] - 2026-07-02
...
### ⚙️  Miscellaneous
- Updated the following local packages: agentic-tools-core, agentic_logging, agentic-tools-mcp, claudecode, thoughts-tool
## [0.4.2] - 2026-05-04
